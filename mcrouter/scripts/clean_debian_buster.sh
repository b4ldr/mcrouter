...
sudo apt-get install -y libdouble-conversion1 libgflags2.2 \
    libboost-program-options1.67.0 libboost-filesystem1.67.0 \
    libboost-system1.67.0 libboost-regex1.67.0 libboost-thread1.67.0 \
    libboost-context1.67.0 libgoogle-glog0v5 libevent-2.1-6 libjemalloc2
